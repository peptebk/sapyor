...
function getTextImg(num) {
  ...
  if (num === 1) return open1;
  if (num === 2) return open2;
  if (num === 3) return open3;
  if (num === 4) return open4;
  if (num === 5) return open5;
  if (num === 6) return open6;
  if (num === 7) return open7;
  if (num === 8) return open8;
}
